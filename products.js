...
window.STORE_DEFAULT = {
  ...
  info: {
    ...
    coupon: "WELCOME3000",
    biz: "상호 청해신푸드 · 대표 문복임 · 통신판매업신고 제2022-경남남해-143호 · 사업자등록번호 314-49-00868<br>주소 경상남도 남해군 삼동면 동부대로 1126, 어부림횟집 2층 · 전화 055-867-3362 · 개인정보관리책임자 문복임<br>© 2026 청해신푸드 · 구매·결제는 남해몰에서 진행됩니다."
  },
  ...
  notices: [
    { cat:"공지",   ev:false, tt:"[배송안내] 신선 상품 냉장 배송 및 지역별 배송 일정 안내", dt:"2026.07.10",
      body:"주문하신 신선·냉장 상품은 안전하게 냉장 포장하여 순차 발송해 드립니다. 지역과 주문 시점에 따라 배송 일정이 달라질 수 있으며, 주문이 몰리는 시기에는 1~2일 정도 지연될 수 있는 점 양해 부탁드립니다. 배송 관련 문의는 고객센터(055-867-3362)로 연락 주세요." },
    { cat:"이벤트", ev:true,  tt:"[이벤트] 첫 구매 고객 3,000원 쿠폰 증정", dt:"2026.07.05",
      body:"청해신푸드를 처음 찾아주신 고객님께 감사의 마음을 담아 3,000원 할인 혜택을 준비했습니다. 참여 방법 등 자세한 내용은 고객센터(055-867-3362)로 문의해 주세요." },
    { cat:"공지",   ev:false, tt:"[안내] 청해신푸드 남해몰 정식 입점 및 판매 안내", dt:"2026.06.28",
      body:"청해신푸드가 남해 특산몰 '남해몰'에 정식 입점하였습니다. 보물섬 명품 쌈장, 당당보물죽, 빼때기죽, 된장찌개 밀키트 등을 남해몰에서 구매하실 수 있습니다. 각 상품 페이지의 '남해몰에서 구매' 버튼을 이용해 주세요." },
    { cat:"이벤트", ev:true,  tt:"[리뷰이벤트] 포토리뷰 작성 시 적립 혜택", dt:"2026.06.20",
      body:"상품을 받아보신 후 사진과 함께 정성스러운 후기를 남겨주신 고객님께 감사 혜택을 드립니다. 자세한 내용은 고객센터(055-867-3362)로 문의해 주세요." }
  ]
};
